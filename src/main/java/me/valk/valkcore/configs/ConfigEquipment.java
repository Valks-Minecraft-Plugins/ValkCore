...
import me.valk.valkcore.customtypes.CustomEntityEquipment;

class ConfigEquipment extends ConfigResource {
	public ConfigEquipment(ConfigManager cm) {
		super(cm);
	}

	public void setDefault(String path, EntityEquipment equip) {
